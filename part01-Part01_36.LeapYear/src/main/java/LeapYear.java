 ...
 *     The year is a leap year.
 *
 * Hint 1: The divisibility by a particular number can be checked using the
 * modulo operator, aka `%`, in the following way.
 *
 * ```java
 * int number = 5;
 *
 ...
 *
 * Hint 2: Think of the problem as a chain of if, else if, else if, ...
 * comparisons, and start building the program from a situation in which you
 * can be certain that the year is not a leap year.
 *
 * ```java
